...
%%      {University of Oslo}
Nils Huus Gate 18          & \textit{E-mail:}
...
Oslo, Norway
\hfill September 2017 to present
\begin{outerlist}
...
\item[] \textit{Developer/Consultant}
  \begin{innerlist}
    ...
    \item Full stack development for Vipps AS
      \begin{innerlist}
        \item Development on Merchantportal, vipps.no etc.
      \end{innerlist}
    \item Front end development for Statens Vegvesen.
      \begin{innerlist}
        \item Minside, for toll management and payment.
      \end{innerlist}
    \item ML pilot project for Fiskeridirektoratet.
      \begin{innerlist}
        \item Risk analysis
      \end{innerlist}
    \item Energy consumption prediction for large warehouse.
    \end{innerlist}
\end{outerlist}
\blankline
