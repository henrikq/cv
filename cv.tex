...
\item[] \textit{Developer/Consultant}
  \hfill Januar 2017 to July 2017
  \begin{innerlist}
      \footnotesize
    \item Front end development for Statens Vegvesen.
      ...
      \end{innerlist}
    \item Maskinlæring pilot prosjekt for Fiskeridirektoratet.
      \begin{innerlist}
        \item Risikovurdering, for lovbrudd ved inspeksjon.
        \item veileding for studenter.
      \end{innerlist}
  \end{innerlist}
\end{outerlist}
\blankline
