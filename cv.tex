...
\href{http://www.mn.uio.no/fysikk/english/}%
     {Department of Physics} 
                           & \textit{Phone:} +47 97606794 \\
\href{http://www.uio.no/english/}
     {University of Oslo}       
                           &  \textit{Fax:} +47 22856422\\
P.O box 1048               & \textit{E-mail:}
                             \href{mailto:henrik.qvigstad@fys.uio.no}
                                  {henrik.qvigstad@fys.uio.no}\\
Blindern                   & \textit{web:}
\href{http://folk.uio.no/henrikq/}{folk.uio.no/henrikq/}
                             %% \textit{E-mail:}
                             %% \href{mailto:henrik.qvigstad@cern.ch}
                             %%      {henrik.qvigstad@cern.ch}
                                  \\
0316 OSLO                  & %% \textit{E-mail:}
...
\section{Summary}
%
Graduating PhD Student, with experience with:
\begin{multicols}{2}
\begin{itemize}
\item Data Analysis;
\item C/C++ Development;
\item Algororithm Testing and Evaluating;
\item Large Scale Computing;
\item System Commisioning Maintanence.
\item[] \
\end{itemize}
\end{multicols}
...
Information Retrival, Artificial Intelligence

%% \section{Research Interests}
%% %
%% %High Transverse Momentum neutral particles at High Energy Nuclear Collision, 
%% High $p_T$ neutral particles at RHIC,
%% Medical Heavy Ion Therapy, Proton Therapy, PET-CT
...
\item[] \textbf{Ph.D.}, 
  \href{http://www.mn.uio.no/fysikk/english/}
       {Department of Physics}, expected graduation date: April 2014
        \begin{innerlist}
...
%%             & English: & Fluent
%%               , some experience in Technical Writing (Documantation)
%% \end{tabular*}
...
\emph{Programming:} C++, C, UNIX shell scripting, Java, Python, and cmake.

\blankline

\emph{Libraries:} Qt, ROOT, AliRoot, AliAnalysis.

\blankline

\emph{Applications:} SVN, Git, autotools, S-Plus, 
...
\emph{equivalent of Mathematics B.S. Graduate in the following subjects:}
